...
import com.rafaelcortez.cursospringboot.domain.PagamentoComCartao;
...
import com.rafaelcortez.cursospringboot.repositories.CidadeRepository;
...
import com.rafaelcortez.cursospringboot.repositories.ProdutoRepository;
...
public class DBService {
	...
	public void instantiateTestDatabase() throws ParseException {
		...
		Cliente cli1 = new Cliente(null, "Maria silva", "rafaelcortezp1@gmail.com", "36378912377", TipoCliente.PESSOAFISICA, pe.encode("123"));
		cli1.getTelefones().addAll(Arrays.asList("27363323", "93838393"));
		
		Cliente cli2 = new Cliente(null, "Ana Costa", "rafaelcortezp@gmail.com", "55041175004", TipoCliente.PESSOAFISICA, pe.encode("123"));
		cli2.addPerfil(Perfil.ADMIN);
		cli2.getTelefones().addAll(Arrays.asList("32598745", "997965487"));
		
		Endereco e1 = new Endereco(null, "Rua Flores", "300", "apto 303", "Jardim", "38220834", cli1, c1);
		Endereco e2 = new Endereco(null, "Avenida Matos", "105", "sala 800", "Centro", "38727012", cli1, c2);
		Endereco e3 = new Endereco(null, "Avenida Flores", "2110", null, "Santa Cruz", "18259874", cli2, c2);
		...
		Pagamento pagto2 = new PagamentoComBoleto(null, EstadoPagamento.PENDENTE, ped2, sdf.parse("20/10/2020 23:59"), null);
